...
(
    ...
    "session_id" uuid not null
        constraint "FK_session_reservations_sessions_session_id"
            references "sessions"
            on delete cascade,
...
(
    "id" integer generated by default as identity
        constraint "PK_session_categories"
            primary key,
    "session_id" uuid not null
        constraint "FK_session_categories_sessions_session_id"
            references "sessions"
            on delete cascade,
    "name" text,
...
create index if not exists "IX_session_categories_session_id"
    on "session_categories" ("session_id");
